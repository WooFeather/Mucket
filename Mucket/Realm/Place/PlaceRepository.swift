...
protocol PlaceRepositoryType {
    ...
    func fetch(in folder: PlaceFolderObject?) -> [PlaceEntity]
    func add(_ place: PlaceEntity, folder: PlaceFolderObject?)
    func update(_ place: PlaceEntity, folder: PlaceFolderObject?)
